...
![image-20200909191142658](./img/image-20200909191142658-8641625.png)
...
> 注意：因为叫链接伪类，所以都是利用交集选择器  `a:link ` ，`  a:hover  `
...
![image-20200909152251692](/Users/xujian/%E5%89%8D%E7%AB%AF%E7%AC%94%E8%AE%B0/webNote/CSS/img/image-20200909152251692-8670002.png)
...
text-decoration通常我们用于给链接修改装饰效果,设置文本是否显示下划线，上划线，删除线
...
![image-20200327000852007](./img/image-20200327000852007.png)
...
![image-20200903155741335](./img/image-20200903155741335.png)
...
![image-20200903160353855](./img/image-20200903160353855.png)
...
![image-20200903155439897](./img/image-20200903155439897.png)
...
<img src="./img/image-20200909235704768.png" alt="image-20200909235704768" style="zoom:50%;" />
...
<img src="./img/image-20200909235850300.png" alt="image-20200909235850300" style="zoom:50%;" />
...
<img src="./img/image-20200910000548710.png" alt="image-20200910000548710" style="zoom:50%;" />
...
清除浮动主要为了解决父级元素因为子级浮动引起内部高度为0 的问题。清除浮动之后， 父级就会根据浮动的子盒子自动检测
...
![image-20200904111431894](./img/image-20200904111431894.png)
...
- 相对于自己原来在标准流中位置来移动的
- 原来在标准流的区域继续占有，后面的盒子仍然以标准流的方式对待它。（不脱离文档流）
- 提升元素的层级
- 定位不继承
...
<img src="./img/04_%E7%9B%B8%E5%AF%B9%E5%AE%9A%E4%BD%8D%E6%A1%88%E4%BE%8B.png" alt="04_相对定位案例" style="zoom:24%;" />
...
<img src="./img/05_%E7%BB%9D%E5%AF%B9%E5%AE%9A%E4%BD%8D_%E7%88%B6%E7%BA%A7%E6%97%A0%E5%AE%9A%E4%BD%8D.png" alt="05_绝对定位_父级无定位" style="zoom:24%;" />

3. **父元素要有定位**

- 将元素依据最近的已经定位（绝对、固定或相对定位）的父元素（祖先）进行定位。

<img src="./img/06_%E7%BB%9D%E5%AF%B9%E5%AE%9A%E4%BD%8D_%E7%88%B6%E7%BA%A7%E6%9C%89%E5%AE%9A%E4%BD%8D.png" alt="06_绝对定位_父级有定位" style="zoom:24%;" />
...
<img src="./img/08_%E5%9B%BA%E5%AE%9A%E5%AE%9A%E4%BD%8D%E6%A1%88%E4%BE%8B.png" alt="08_固定定位案例" style="zoom:24%;" />
...
![image-20200326235757304](./img/image-20200326235757304.png)
...
<img src="./img/11_%E7%BB%9D%E5%AF%B9%E5%AE%9A%E4%BD%8D%E5%B1%85%E4%B8%AD%E7%A4%BA%E6%84%8F%E5%9B%BE.png" alt="11_绝对定位居中示意图" style="zoom:24%;" />
...
3. 两种布局方式的不同之处在于如何处理中间主列的位置：
   ...
   - 双飞翼布局是把主列嵌套在一个新的父级块中利用主列的左、右内边距进行布局调整
...
![image-20200904151101767](./img/image-20200904151101767.png)

## 14.BFC

BFC（Block formatting context）直译为块级格式化上下文。为元素提供了一个独立的布局环境，环境中的内容不会影响

到环境外的布局，环境外的布局也不会影响到环境中的内容。就像是一个围墙。
...
![image-20200909234411501](./img/image-20200909234411501.png)
...
![image-20200909234438621](/Users/xujian/%E5%89%8D%E7%AB%AF%E7%AC%94%E8%AE%B0/webNote/CSS/img/image-20200909234438621.png)
...
![ao](/Users/xujian/%E5%89%8D%E7%AB%AF%E7%AC%94%E8%AE%B0/webNote/CSS/img/ao.png)
