...
<img src="./img/image-20200909191142658-8641625.png" alt="image-20200909191142658" style="zoom:50%;" />
...
#right{
		height: 200px;
    	/*开启BFC*/
  	/* 如果不开启bfc，则right区域会延伸到left区域，并且left会在上面*/
		overflow: hidden;
		background: deeppink;
}
```

![image-20221022232600491](./img/image-20221022232600491.png)
...
![image-20200909234438621](./img/image-20200909234438621.png)
